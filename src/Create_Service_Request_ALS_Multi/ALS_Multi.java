package Create_Service_Request_ALS_Multi;
...
public class ALS_Multi 
{
	...
	@Test(priority=1)
	public void HiFillPatientInformationALSDefaultMulti() throws Exception
	{
	...
	driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
		...
		@Test(priority=2)
		public void HiFillPatientInformationALSCustomAndDefaultMulti() throws Exception
		{
		...
		driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
			...
			@Test(priority=3)
			public void HiFillPatientInformationALSCustomMulti() throws Exception
			{
			...
			driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
				...
				@Test(priority=4)
				public void HiFillPatientInformationALSDefaultAndCustomMulti() throws Exception
				{
