...
public class HI_Login 
{
	...
	public void init4() throws Exception
	{
		...
		driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
			...
			@Test(priority=1)
			public void acuityinvalid() throws Exception
			{
				Data_Acuity.setExcelFile(Constant_Acuity.Excelpath,"Sheet1");
			...
			/*@Test(priority=2)
			public void acuityinvalid1() throws Exception
			{
				...
				Data_Acuity.setExcelFile(Constant_Acuity.Excelpath,"Sheet1");
						...
						Thread.sleep(2000);
						WebElement ele8=driver.findElement(By.xpath("//div[text()= 'Username and Password does not match. Try again.']"));
			...
			@Test(priority=3)
			public void acuityinvalid2() throws Exception
			{
					Data_Acuity.setExcelFile(Constant_Acuity.Excelpath,"Sheet1");
					...
					Thread.sleep(2000);
					WebElement ele9=driver.findElement(By.xpath("//div[text()= 'Username and Password does not match. Try again.']"));
...
@Test(priority=2)
public void acuityvalid() throws Exception
{
		Data_Acuity.setExcelFile(Constant_Acuity.Excelpath,"Sheet1");
