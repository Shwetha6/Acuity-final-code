...
public class HI_Reg 
{
	...
	@Test
	public void hireg() throws Exception
	{
			Data_Acuity.setExcelFile(Constant_Acuity.Excelpath,"Sheet3");
	 ...
	 driver.findElement(By.xpath("//button[contains(text(),'Register as Health')]")).click();
	   ...
	   //new Select(driver.findElement(By.id("hitype"))).selectByVisibleText(type);
	    ...
	    Thread.sleep(3000);
	    WebElement ele27=driver.findElement(By.id("email"));
		String t25=ele27.getText();
		System.out.println("Field name is:"+ t25);
		SoftAssert s15= new SoftAssert();
		s15.assertEquals(ele27, "");
