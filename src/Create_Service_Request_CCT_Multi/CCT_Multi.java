package Create_Service_Request_CCT_Multi;
...
public class CCT_Multi 
{
	...
	@Test(priority=1)
	public void HiFillPatientInformationCCTDefaultAndCustomMulti() throws Exception
	{
	...
	driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
		...
		@Test(priority=2)
		public void HiFillPatientInformationCCTDefaultMulti() throws Exception
		{
		...
		driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
			...
			@Test(priority=3)
			public void HiFillPatientInformationCCTCustomAndDefaultMulti() throws Exception
			{
			...
			driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
				...
				@Test(priority=4)
				public void HiFillPatientInformationCCTCustomMulti() throws Exception
				{
