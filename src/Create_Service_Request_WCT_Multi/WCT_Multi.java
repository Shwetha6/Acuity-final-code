package Create_Service_Request_WCT_Multi;
...
public class WCT_Multi 
{
	...
	@Test(priority=1)
	public void HiFillPatientInformationWCTDefaultAndCustomMulti() throws Exception
	{
	...
	driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
		...
		@Test(priority=2)
		public void HiFillPatientInformationWCTDefaultMulti() throws Exception
		{
		...
		driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
			...
			@Test(priority=3)
			public void HiFillPatientInformationWCTCustomAndDefaultMulti() throws Exception
			{
			...
			driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
				...
				@Test(priority=4)
				public void HiFillPatientInformationWCTCustomMulti() throws Exception
				{
